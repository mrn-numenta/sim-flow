...
```docs/critiques/DM2a-critique.json
...
`docs/critiques/DM2a-critique.json`. The orchestrator renders a
human-readable `docs/critiques/DM2a-critique.md` from that JSON
...
`kind` values: `"blocker"`, `"unresolved"`, `"resolved"`. The
