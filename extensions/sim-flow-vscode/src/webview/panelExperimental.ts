...
interface UiState {
   ...
   * these IDs render disabled and append " ..." to the label.
   */
...
function tabs(): HTMLElement {
  ...
  //   1. per-project input (Prompt Overrides, Block Diagram)
  //   2. cross-run data / analysis (Run History, Baselines, Sweeps)
...
function panel(id: TabId, content: Node[]): HTMLElement {
  ...
  return el("section", { class: cls }, ...content);
}
