...
<!--
This file MUST stay in sync with CLAUDE.md. When updating agent
guidance, mirror the same content into CLAUDE.md so Claude Code,
Codex, and Copilot sessions receive identical project context.
-->
